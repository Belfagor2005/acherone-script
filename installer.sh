...
wget --no-check-certificate 'https://github.com/Belfagor2005/acherone-script/archive/refs/heads/main.tar.gz'
tar -xzf main.tar.gz
cp -r 'acherone-script-main/usr' '/'
set +e
cd
sleep 2
...
exec > >(tee -a /tmp/acherone_debug.txt) 2>&1
set -x
